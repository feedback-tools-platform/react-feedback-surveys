...
import styles from './CSAT5Emojis.module.scss';
...
export interface CSAT5EmojisProps {
...
const SurveyCSAT5Emojis: React.FC<CSAT5EmojisProps> = ({
  labelLeft,
  labelRight,
  onChange,
  classNames
...
export default SurveyCSAT5Emojis;
